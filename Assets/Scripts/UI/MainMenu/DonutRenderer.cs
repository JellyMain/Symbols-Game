...
namespace UI
{
    ...
    public class DonutRenderer : MonoBehaviour
    {
        ...
        [SerializeField] private int asciiScreenWidth = 80;

        [Tooltip("Height of ASCII display in characters.")]
        [SerializeField] private int asciiScreenHeight = 22;
        ...
        [SerializeField] private float cubeHalfSize = 10f;

        [Tooltip("Step size for drawing cube faces (smaller = smoother, but slower).")]
        [SerializeField] private float cubeDetailStep = 0.5f;
        ...
        [SerializeField] private float donutDetailStep = 0.2f;
